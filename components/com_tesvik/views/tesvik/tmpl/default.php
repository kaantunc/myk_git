			...
			if($row['DURUM'] == 0){
				...
				echo '<td>
						<button type="button" class="btn btn-xs btn-info">Ödeme Beklemede</button><br>
					 	<a target="_blank" href="index.php?option=com_tesvik&view=tesvik&layout=tesvikpdfbanka&tesvikId='.$row['ID'].'" class="btn btn-xs btn-success">Bankaya Gönderilen Txt</button>
					 </td>';
			}else if($row['DURUM'] == 5){
				echo '<td>';
