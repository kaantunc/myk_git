...
<form id="TesvikIstek" action="index.php?option=com_tesvik&task=TesvikAdayEditKaydet" enctype="multipart/form-data" method="post">
<!-- <input type="hidden" name="bas_tarih" value="<?php echo $this->basTarih;?>"/> -->
<input type="hidden" name="tesvikId" value="<?php echo $this->tesvikId;?>"/>
<div class="anaDiv">
...
// 			}
			if(in_array($row['BELGENO'], $tesvikAday)){
				...
				echo '<td><input type="checkbox" name="tesvik[]" value="'.$row['BELGENO'].'"/></td>';
			}
