...
$html .= '</tr>';
	...
	foreach($AdayBilgi as $row){
		...
		$html .= '<td width="6%" style="text-align:center">'.$row['ILK_SINAV_TARIHI'].'</td>';
...
$html .= '<li>Bu liste 1 nüsha halinde "Onaylı Kişiler Listesi"ne göre kesilecek fatura ile beraber MYK‘ya iletileceğini</li>';
$html .= '</ul>';
...
$pdf->writeHTMLCell(0, 0, 200, '', $html, 0, 1, 0, true, 'C', true);
