...
<div class="form_content">
	<form method="post" id="yeniProtokolForm"
		...
		<div style="<?php echo $kurulusVeYeterlilikVisibilitysi; ?>"  class="yeterlilik_wrapper">
			<div>
				...
				<div id="container">
					...
					<div>
						<div style="float:left; padding-top: 10px;padding-bottom: 10px;">
							<a id="newYeterlilik" href="">Yeni Yeterlilik Ekle </a><font id="yeniYeterlilikEkleButtonError" color="red"></font>
						</div>
						<div style="float:left; padding: 10px 0 10px 20px;">
							<a id="addExistingMeslekStandart" href="">Varolan Yeterlilik Ekle</a>
						</div>
						<div style="float:left; padding: 10px 0 10px 20px;">
							<a id="newRevizyonYeterlilikEkle" href="">Yeni Revizyon Ekle </a><font id="newRevizyonYeterlilikEkleButtonError" color="red"></font>
						</div>
					</div>
					<div style="display: none; float:left; width:100%; margin-bottom:10px; border: 1px solid #898989" class="existing_yeterlilik_wrapper"
						id="existing_yeterlilik_wrapper">
						...
						<div id="existing_yeterlilik_container">
							...
							<div id="varolanYeterliliklerContainer" style="padding: 5px; display:none;"> 
								...
								<div style="padding-top:10px; width:100%">
									<a style="display: none;"  href='' class='varolanYeterlilikEkleButton'>Seçilenleri Ekle</a>
								</div>
							</div>
...
jQuery(document).ready(function() {	
    ...
    var oTableMS = jQuery('#yeterlilikler').dataTable(settings);  
    var oTableVarolanMS = jQuery('#existing_yeterlilikler').dataTable(settings);
    ...
    jQuery('#yeterlilikler a.editMeslekStandart').live('click', function (e) {
        e.preventDefault();
    ...
    jQuery('#yeterlilikler a.saveMeslekStandart').live('click', function (e) {
        e.preventDefault();
    ...
    jQuery('#newYeterlilik').click( function (e) {
    	...
    	{
    		jQuery('#yeniYeterlilikEkleButtonError').html("Revizyon Yetkilendirmesine Yeni Standart Eklenemez");
        }
    	else
    	{
            e.preventDefault();
    ...
    jQuery('#yeterlilikler a.deleteMeslekStandart').live('click', function (e) {
        e.preventDefault();
        var nRow = jQuery(this).parents('tr')[0];
    ...
    jQuery('#yeterlilikler a.cancelEditMeslekStandart').live('click', function (e) {
    	e.preventDefault();
    ...
    jQuery('#addExistingMeslekStandart').click( function (e) {
		...
		if(existingStandartHidden==0)//gizli değilse gizle
    	{
	    	...
	    	jQuery('#existing_yeterlilik_wrapper').hide("slow");
    		jQuery('#existing_seviyeler').val(0);
    		jQuery('#existing_sektorler').val(0);

    		var oTableVarolanMS = jQuery('#existing_yeterlilikler').dataTable();
    	...
    	{
    		jQuery('#existing_yeterlilik_wrapper').show("slow");
    		//jQuery('#existing_yeterlilikler').show("slow");
    		//jQuery('.varolanYeterlilikEkleButton').show("slow");
...
function existingVariablesChanged()
{
	...
	{	//IKISI DE SECILI DEGIL
		...
		jQuery(".varolanYeterlilikEkleButton").hide("slow");
		jQuery("#existing_yeterlilikler").hide("slow");
	...
	else
	{
		...
		if(jQuery("#existing_seviyeler").val()!= 0  ) ;
			...
			var revizyonMu;
// 			if(jQuery('#varolanYeterlilikEkle_RevizyonluCheckbox_Revizyon').attr('checked')=='checked')//revizyonsa
...
//
jQuery('.varolanYeterlilikEkleButton').live('click', function (e) {
...
jQuery("#newRevizyonYeterlilikEkle").click(function(){
...
jQuery(".cancelRevizyon").live('click',function(){
	var oTableMS = jQuery('#yeterlilikler').dataTable();
	var nRow = jQuery(this).parents('tr')[0]; 
	oTableMS.fnDeleteRow( nRow );
	return false;
});
