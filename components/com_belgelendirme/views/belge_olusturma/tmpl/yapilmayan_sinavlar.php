...
<form id="SinavAraForm" method="POST" enctype="multipart/form-data" action="index.php?option=com_belgelendirme&view=belge_olusturma&layout=yapilmayan_sinavlar">
    <div class="anaDiv">
