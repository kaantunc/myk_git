...
?>
<form id="SinavAraForm" method="POST" enctype="multipart/form-data" action="index.php?option=com_belgelendirme&view=belge_olusturma&layout=sonuc_sinavlar">
    <div class="anaDiv">
...
jQuery(document).ready(function(){
	...
	jQuery('#sinavAra').live('click',function(e){
		...
		jQuery.ajax({
			...
			data:'yeterlilik_id='+yet+'&kurulus_id='+kur+'&basTarih='+bas+'&bitTarih='+bit+'&durum=1',
...
<div id="SinavIptalDiv" style=" width: 50%; min-height:100px; background-color: white; border:1px solid #00A7DE; display: none; padding:20px">
    <form method="POST" id="SinavIptalFormu" action="index.php?option=com_belgelendirme&view=belge_olusturma&layout=sonuc_sinavlar&task=program_iptal" enctype="multipart/form-data">
