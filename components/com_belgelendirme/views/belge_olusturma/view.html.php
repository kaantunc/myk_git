        ...
        $file = JRequest::get('files');
			...
			$sayfalar=array("yapilan_sinavlar"=>"Tamamlanmış Sınavlar","gelecek_sinavlar"=>"Açık Sınavlar",
         	...
         	if($layout == 'gelecek_sinavlar'){
         		...
         		$sayfaLink.='<td><a href="'.$redirect.'&layout=sonuc_sinavlar" style="border:1px solid #1C617C;padding:5px;background-color:#ffffff;color:black;">Sonuç Bildirimi Yapılmamış</a></td>';
         	}else if($layout == 'sonuc_sinavlar'){
         		...
         		$sayfaLink.='<td><a href="'.$redirect.'&layout='.$layout.'" style="border:1px solid #1C617C;padding:5px;color:white;background-color:#3C91FF;font-weight:bold;">Sonuç Bildirimi Yapılmamış</a></td>';
         	}else{
         		$sayfaLink.='<td><a href="'.$redirect.'&layout=gelecek_sinavlar" style="border:1px solid #1C617C;padding:5px;background-color:#ffffff;color:black;">Yapılacak Sınavlar</a></td>';
         		$sayfaLink.='<td><a href="'.$redirect.'&layout=sonuc_sinavlar" style="border:1px solid #1C617C;padding:5px;background-color:#ffffff;color:black;">Sonuç Bildirimi Yapılmamış</a></td>';
         	}
