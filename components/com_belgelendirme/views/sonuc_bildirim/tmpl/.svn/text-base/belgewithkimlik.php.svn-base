...
<hr><br>
<div>
	<label>T.C. Kimlik No ile Ara</label><br>
</div>

<div id="BelgeSorgulaAday" style="display:inline-block">
<hr>
	...
	jQuery('#Tckngetir').live('click',function(e){
        ...
        if(tckn == ''){
        	...
        	jQuery.ajax({
                ...
                data:'tckn='+tckn+'&durum_id=2&kurulusId=<?php echo $this->kurulusId; ?>',
...
//                                 }
                            ...
                            alert('Bu Kimlik numarası ile belgelendirdiğiniz adayınız bulunmamaktadır.');
                        }
                    }
            });
		}
