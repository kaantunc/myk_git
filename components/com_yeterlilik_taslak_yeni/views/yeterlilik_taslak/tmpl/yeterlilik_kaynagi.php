...
<div class="form_item" id="tabloDIV" onblur="validateYeterlilikKaynaklari();" onmouseout="validateYeterlilikKaynaklari();" >
...
?>
	<div class="form_item" style="padding-top: 25px;">
		<div class="form_element cf_button">
			<input value="Kaydet" id="kaydetButton"  onmouseover="validateYeterlilikKaynaklari();" name="kaydet" type="submit" />
		</div>
		<div class="cfclear">&nbsp;</div>
	</div>
<?php 
...
$r = $r.$s.'),"comboReq kaynakMeslek", "", "200"), new Array("text","", "40", "", readOnly) );';
echo $r;
?>
//KAYNAK MESLEK SONU
