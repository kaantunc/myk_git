...
<form
	...
	action="index.php?option=com_yeterlilik_basvur&amp;layout=basvuru_yeni&amp;task=yeterlilikKaydetYeni"
...
<?php 
echo '<h2><u>'.$this->kurulus['KURULUS_ADI'].' Ulusal Yeterlilik Hazırlama Başvuru Formu</u></h2>';
//echo $this->pageTree;
?>
<br/>
<?php 
	if($this->evrak_id <> "" && ($basvuru['BASVURU_DURUM_ID'] == "-1" || $basvuru['BASVURU_DURUM_ID'] == "2")){?>
		<input style="padding:5px; margin: 10px 0 25px 29px;" type="button" name="gonder" value="Tüm Basvuruyu Görüntüle / Bitir" onclick="basvuruGonder(-1)">
<?php } ?>
<div class="form_item">
	  		...
	  		<tr id="new_document_add_container" style="display:none;">
	  			<td colspan="4" style="padding-top:15px;">
	  				<center>
		  				...
		  				<input style="background-color:green;color:#ffffff" type="button" id="SaveDoc" value="Kaydet">
