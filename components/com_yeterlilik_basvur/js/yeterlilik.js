...
function goToPage(page, evrak_id){
    ...
    form.action ='index.php?option=com_yeterlilik_basvur&Itemid=211&layout='+page+'&evrak_id='+evrak_id; 
...
function basvuruGonder(){
	var form = document.ChronoContact_yeterlilik_basvuru_t2; 
    form.action ='index.php?option=com_yeterlilik_basvur&layout=tum_basvuru'; 
