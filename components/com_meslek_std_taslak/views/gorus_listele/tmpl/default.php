...
<table cellspacing="0" class="paginate-10 sortable">
	...
	<?php
		...
		foreach($sonuclar AS $satir){
			...
			echo '<td><a href="index.php?option=com_meslek_std_taslak&view=gorus_ayrinti&gorusId='.$satir['GORUS_ID'].'&standartId='.$this->standartId.'">Ayrıntılar</a></td>';
			echo '</tr>';
			$rowCount++;
		}
	?>
...
<br />
<br />
<a target="_blank" href="index.php?option=com_meslek_std_taslak&view=gorus_listele&layout=pdf&format=pdf&standartId=<?php echo $this->standartId;?>">PDF Çıktısı Al</a>
