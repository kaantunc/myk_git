...
function goToPage(page, evrak_id){
    ...
    form.action ='index.php?option=com_meslek_std_basvur&Itemid=210&layout='+page+'&evrak_id='+evrak_id; 
...
function basvuruGonder($evrak_id){
    var form = document.ChronoContact_meslek_std_basvuru_t1; 
    form.action ='index.php?option=com_meslek_std_basvur&layout=tum_basvuru&evrak_id='+$evrak_id; 
