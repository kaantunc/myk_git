...
function showform( $row, $posted ) {
	...
	if((!empty($MyForm->formrow->name))&&($MyForm->formrow->published)){
        ...
        <?php if ($MyForm->formparams('LoadFiles') == 'Yes'){ ?>        	
            ...
            <link href="<?php echo $CF_PATH.'components/com_chronocontact/css/'; ?>tablo_panel.css" rel="stylesheet" type="text/css" />
            
            		<script type="text/javascript" src="<?php echo $CF_PATH.'/administrator/components/com_chronocontact/js/'; ?>addrow.js"></script>
            		<script type="text/javascript" src="<?php echo $CF_PATH.'/administrator/components/com_chronocontact/js/'; ?>pagination.js"></script>
            		<script type="text/javascript" src="<?php echo $CF_PATH.'/administrator/components/com_chronocontact/js/'; ?>dosya_gonder.js"></script>
            		<script type="text/javascript" src="<?php echo $CF_PATH.'/administrator/components/com_chronocontact/js/'; ?>panel.js"></script>
            		<script type="text/javascript" src="<?php echo $CF_PATH.'/administrator/components/com_chronocontact/js/'; ?>myjsvalidator.js"></script>
