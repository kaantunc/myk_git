...
?>
<form method="post" action="index.php?option=com_sinav&task=ucretTarifesiKaydet&kurulus_id=<?php echo $_GET['kurulus_id']; ?>&ucret_tarifesi_id=<?php echo $ucretTarifesi['UCRET_TARIFESI_ID']; ?>" >
...
<tbody>
<?php 
echo '<h4>'.$kurulusad.' BELGELENDIRME PROGRAMI ÜCRETLERİ</h4>';
