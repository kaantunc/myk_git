...
class Yeterlilik_TaslakModelYeterlilik_Taslak_Old extends JModel {
...
// 			$return['birims'][$cow['ALTERNATIF_ID']] = $birimdata;
	...
	function getBiriminOlcmeDegerlendirmeleri($birimID, $olcmeDegerlendirmeTipi )
	{
		...
		$sql= "SELECT BIRIM_ID,
					  TUR_ADI AS OLC_DEG_ADI,
					  TUR_ACIKLAMA AS OLC_DEG_ACIKLAMA,
					  TUR_KODU,
					  TUR,
					  '0' AS YENI_MI
				 FROM M_YETERLILIK_ALT_BIRIM_TUR 
				WHERE BIRIM_ID = ? AND TUR_KODU LIKE '".$olcmeDegerlendirmeTipi."%' ORDER BY TUR";
	...
	function getEklenmisBirim ($yeterlilik_id){//Azat
		...
		$sql= "SELECT 	m_yeterlilik.yeterlilik_id, 
						...
						m_yeterlilik_alt_birim.YETERLILIK_ALT_BIRIM_NO as birim_kodu,
					  ...
					  y2.*
						...
						m_yeterlilik,  
						m_yeterlilik_alt_birim,
						(select yeterlilik_id as bagimli_oldugu_yet_id2, yeterlilik_adi as bagimli_oldugu_yeterlilik_adi, yeterlilik_kodu as bagimli_oldugu_yet_kodu, seviye_id as bagimli_oldugu_yet_seviye_id from m_yeterlilik) y2 
						WHERE m_yeterlilik.yeterlilik_id= ? AND 
						      m_yeterlilik.yeterlilik_id = m_yeterlilik_alt_birim.yeterlilik_id
						AND m_yeterlilik_alt_birim.YETERLILIK_ID = y2.bagimli_oldugu_yet_id2 (+)
						ORDER BY m_yeterlilik_alt_birim.YETERLILIK_ALT_BIRIM_ID";
