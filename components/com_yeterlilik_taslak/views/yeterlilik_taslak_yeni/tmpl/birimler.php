...
dTables.zorunlu_birim =  new Array(new Array("text","", "1", "", readOnly),
								   ...
								   new Array("textarea","required","1","3",readOnly),
								   new Array("textarea","required","1","3",readOnly),
								   new Array("textarea","required","1","3",readOnly),
								   new Array("textarea","required","1","3",readOnly),
								   new Array("textarea","required","1","3",readOnly),
...
function createTables(){
	...
	var headers	  = new Array ('Sıra No',
							   ...
							   'Revizyon No',
							   'Revizyon Tarihi',
							   'Yeterlilik Birimine Kaynak Teşkil Eden Meslek Standart(lar)ı',
							   'Yeterlilik Birimini Geliştiren Kurum / Kurulul(lar)',
							   'Yeterlilik Birimini Doğrulayan Sektör Komitesi',
							   'MYK Yönetim Kurulu Onay Tarihi'
							   );
