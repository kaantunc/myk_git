...
echo 'action=index.php?option=com_yeterlilik_taslak&layout=tanitim&'.$task.'&yeterlilik_id='.$this->yeterlilik_id;	
?>
...
<div class="form_item">
  <div class="form_element cf_heading">
  	<h1 class="contentheading">AMACI ve GEREKÇESİ</h1>
  </div>
  <div class="cfclear">&nbsp;</div>
</div>
...
dTables.standart = new Array(new Array("text","","4", "", readOnly),
