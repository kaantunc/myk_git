...
echo 'action=index.php?option=com_yeterlilik_taslak&layout=ek_terim&'.$task.'&yeterlilik_id='.$this->yeterlilik_id;	
?> 
...
<div class="form_item">
  <div class="form_element cf_heading">
  	<h2 class="contentheading">EK1 : Terimler, Simgeler ve Kısaltmalar</h2>
  </div>
  <div class="cfclear">&nbsp;</div>
</div>
