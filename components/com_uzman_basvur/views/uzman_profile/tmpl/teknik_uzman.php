...
<div class="anaDiv font18">
	...
	<?php if($taahut && $kurulus['BASVURU_DURUM'] == 0){ ?>
		...
		<div class="content">
			<div class="anaDiv">
				<table width="100%" style="text-align:center;margin-bottom:10px;border-radius:5px" border="1" class="display compact">
					...
					<?php foreach($this->tuKanit as $row){
	...
	<div class="container">
		<div class="content">
			...
			<div class="anaDiv">
				...
				<textarea rows="10" class="inputW100" name="musait"><?php echo $this->tuMusait?$this->tuMusait['MUSAIT']:''; ?></textarea>
