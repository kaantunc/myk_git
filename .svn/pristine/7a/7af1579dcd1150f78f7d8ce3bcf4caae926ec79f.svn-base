<form
	...
	action="index.php?option=com_yeterlilik_basvur&amp;layout=ek&amp;task=yeterlilikKaydet"
...
<hr>
<div class="form_item">
  <div class="form_element cf_placeholder"><div id="personelForm_panel_div" class="panel_main_div"></div></div>
  <div class="cfclear">&nbsp;</div>
</div>
<?php
...
jQuery(".monthpicker").live("hover",function(){
...
//EK Paneli
dPanels.personelForm_panel = new Array("EK: ULUSAL YETERLİLİK GELİŞTİRME EKİBİNDE GÖREVLENDİRİLEN PERSONELE İLİŞKİN BİLGİ FORMU",
		new Array("1. Kişisel Bilgiler", "baslik"),
		new Array("T.C. Kimlik No/ Pasaport No", "text", ""),
		new Array("Adı", "text", "required"),
		new Array("Soyadı", "text", "required"),
		...
		new Array("3. Yetkinliklere ilişkin diğer sertifika/belgeler", "baslik"),
		new Array("", "dtablo", createDigerSertifikaEgitim),
		new Array("4. Yeterlilik geliştirme sürecine ilişkin  alınan eğitimler/özel deneyimler", "baslik"),
		new Array("", "textarea", "", "5", "50"),
		new Array("5. İş Deneyimi", "baslik"),
	 	new Array("", "dtablo", createIsDeneyimiTable),
	 	new Array("6. Yabancı Dil Bilgisi (1-Çok iyi / 5-Başlangıç)", "baslik"),
		new Array("", "dtablo", createYabanciDilTable));

//ekteki tablo verileri
dTables.egitim = new Array(
		new Array("text","monthpicker required","5"), 
		new Array("text","monthpicker required","5"), 
		//new Array("text","date","10","date"), 
		//new Array("text","date","10","date"), 
		new Array("text", "required")
		);
...
jQuery(".year").live("focus",function (){
	jQuery(this).mask("9999");
});
jQuery(".monthYear").live("focus",function (){
	jQuery(this).mask("99/9999");
});
