...
<div class="anaDiv">
<h2><u>Belgelendirme Kuruluşlarına Yetki Onayı Verme</u></h2>
</div>
<form id="yetYetkiForm" method="post" enctype="multipart/form-data" action="index.php?option=com_belgelendirme_yetki&view=belgelendirme_yetki_onay&layout=kurulus_yetki">
<div class="anaDiv">
