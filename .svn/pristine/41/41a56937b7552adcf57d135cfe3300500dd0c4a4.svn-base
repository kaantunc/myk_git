...
<form id="sinavTakvimiGeriForm" action="index.php?option=com_sinav&view=sinav_oncesi_incele&sinavId=<?php echo $_POST['sinavId']; ?>" method="post">
	<input name="mode" value="duzenle" type="hidden"></input>
	<input type="submit" value="Geri" />
</form>

<form method="POST"
		action="?option=com_sinav&task=sinavOncesiInceleKaydet"
