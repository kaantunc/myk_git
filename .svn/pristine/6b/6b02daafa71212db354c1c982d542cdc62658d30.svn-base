<?php
$baslik = "Yeterlilik Protokol İstatistikleri";
$istatistik_protokol_yeterlilik = $this->istatistik_protokol_yeterlilik;
?>
<style type="text/css">
...
<?php
if(empty($istatistik_protokol_yeterlilik)){
...
<table cellspacing="0" border="1">
	<tr class="tablo_header">
		...
		<th class="sortable-numeric">Protokol Kapsamındaki Yeterlilik Sayısı</th>
	</tr>
<?php }
	$rowCount=1;
	$toplam = 0;
	foreach($istatistik_protokol_yeterlilik AS $yetki){
		...
		echo '<td>'.$yetki['YETERLILIK_SAYI'].'</td>';
		echo '</tr>';
		
		$toplam += $yetki['YETERLILIK_SAYI'];
		$rowCount++;
	}
?>
<tr>
