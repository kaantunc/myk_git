...
class Yetkilendirme_YetModelYetkilendirme_Yet_Kaydet extends JModel {
	...
	/*OK*/function protokolEkle($protokolID, $protokolAdi, $yetkiBaslangici, $yetkiBitisi,$yetkilendirmeSuresi, $yetkilendirme_turu, $filePath, $ilgili_protokol_id)
	{
		...
		$params = array ($protokolID, $protokolAdi, $yetkiBaslangici , $yetkiBitisi, 1, PM_PROTOKOLTURU_YETERLILIKPROTOKOLU,$yetkilendirmeSuresi, $yetkilendirme_turu, $filePath, $ilgili_protokol_id);
		$messageToReturn = $db->prep_exec_insert($sql, $params);			
