...
<table cellspacing="0" class="paginate-10 sortable">
	...
	<?php
		...
		foreach($sonuclar AS $satir){
			...
			echo '<td>'.getEvrakDurumAdi ($satir['YETERLILIK_ID']).'</td>';
			echo '<td><a href="index.php?option=com_yeterlilik_taslak_yeni&layout=tanitim&yeterlilik_id='.$satir['YETERLILIK_ID'].'">Görüntüle</a></td>';
