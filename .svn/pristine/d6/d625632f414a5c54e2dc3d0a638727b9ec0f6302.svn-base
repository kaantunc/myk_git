	...
	foreach ($this->gorusler as $gorus){
		if ($gorus_id != $gorus["GORUS_ID"]){
			$html .= '<br />
					  ...
					  <table>
						<tr>
							<td width="'.$width.'"><strong>Son Görüş Verme Tarihi :</strong></td>
							<td>'.$gorus["SON_GORUS_TARIH"].'</td>
						</tr>
						<tr>
							<td width="'.$width.'"><strong>Görüş Bildiren Kuruluş/Kişi/Unvanı :</strong></td>
							<td>'.$gorus["GORUS_BILDIREN"].'</td>
						</tr>
						<tr>
							<td width="'.$width.'"><strong>Görüş Bildiren E-posta :</strong></td>
							<td>'.$gorus["GORUS_E_POSTA"].'</td>
						</tr>
						<tr>
							<td width="'.$width.'"><strong>Görüş Bildiren Telefon :</strong></td>
							<td>'.$gorus["GORUS_TELEFON"].'</td>
						</tr>
						<tr>
							<td width="'.$width.'"><strong>Görüş Bildiren Faks :</strong></td>
