...
echo 'action=index.php?option=com_yeterlilik_taslak_yeni&layout=ek_9&'.$task.'&yeterlilik_id='.$this->yeterlilik_id;	
?> 
...
<div class="form_item">
  <div class="form_element cf_heading">
  	<h2 class="contentheading">EK 9 : Yeterlilik Sinavina Giriş Şartları ve Belge Geçerlilik Süresine İlişkin Açıklamalar</h2>
  </div>
  <div class="cfclear">&nbsp;</div>
</div>
...
?>
	<div class="form_item" style="padding-top: 25px;">
		<div class="form_element cf_button">
			<input value="Yorum Kaydet" name="kaydet" type="button"  onclick="yorumKaydet('ek_9', <?php echo $this->yeterlilik_id;?>)"/>
		</div>
		<div class="cfclear">&nbsp;</div>
	</div>
<?php 
