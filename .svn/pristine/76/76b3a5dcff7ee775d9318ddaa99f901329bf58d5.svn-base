...
<input type="button" id="ekleButton" value="Listeye Ekle" />
    ...
    <table id="tutumDavranisListesi" style="margin-left: auto; margin-right: auto;" >
...
window.datatablosuAdi="tutumDavranisListesi";
window.datatablosuSatiradi="tutumDavranisSatir";
dtalanlar= new Array("tutumDavranis");
...
function satirekle(id,veri){
    ...
    satir='<tr class="tablo_row" id="tutumDavranisSatiry'+window.yeniSatirId+'"><td style="text-align:center;">'+yeniSatir+'</td>';
    for(i=0;i<window.count;i++){
...
//satirekle('tutumDavranisListesi');
...
jQuery('#ekleButton').click(function(e) {
    ...
    for(k=0;k<veri.length;k++){
        satirekle('tutumDavranisListesi',veri[k]);
