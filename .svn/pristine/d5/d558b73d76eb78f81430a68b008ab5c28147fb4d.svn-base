...
<input type="button" id="ekleButton" value="Listeye Ekle" />
    ...
    <table id="bilgiBeceriListesi" style="margin-left: auto; margin-right: auto;" >
...
window.datatablosuAdi="bilgiBeceriListesi";
window.datatablosuSatiradi="bilgiBeceriSatir";
dtalanlar= new Array("bilgiBeceri");
...
function satirekle(id,veri){
    ...
    satir='<tr class="tablo_row" id="bilgiBeceriSatiry'+window.yeniSatirId+'"><td style="text-align:center;">'+yeniSatir+'</td>';
    for(i=0;i<window.count;i++){
...
jQuery('#ekleButton').click(function(e) {
    ...
    for(k=0;k<veri.length;k++){
        satirekle('bilgiBeceriListesi',veri[k]);
