...
echo 'action=index.php?option=com_yeterlilik_taslak&layout=sinav_bilgi&'.$task.'&yeterlilik_id='.$this->yeterlilik_id;	
?>
...
<div class="form_item">
  <div class="form_element cf_heading">
  	<h1 class="contentheading">ÇALIŞMA ORTAMI ve KOŞULLARI</h1>
  </div>
...
<div class="form_item">
  <div class="form_element cf_heading">
  	<h1 class="contentheading">YETERLİLİK İÇİN UYGULANACAK SINAV ve DEĞERLENDİRMEYE İLİŞKİN BİLGİLER</h1>
  </div>
  <div class="cfclear">&nbsp;</div>
</div>
...
<div class="form_item">
  <div class="form_element cf_heading">
  	<h2 class="contentheading">A) Sınav ve Değerlendirme Araçlarına İlişkin Bilgiler</h2>
  </div>
  <div class="cfclear">&nbsp;</div>
</div>
...
<div class="form_item">
  <div class="form_element cf_heading">
  	<h2 class="contentheading">Teorik Ölçme Araçları</h2>
  </div>
  <div class="cfclear">&nbsp;</div>
</div>
...
<div class="form_item">
  <div class="form_element cf_heading">
  	<h2 class="contentheading">Performansa Dayalı Ölçme Araçları</h2>
  </div>
  <div class="cfclear">&nbsp;</div>
</div>
...
<div class="form_item">
  <div class="form_element cf_heading">
  	<h2 class="contentheading">Sınav ve Değerlendirme Araçlarıyla İlgili Diğer Koşullar</h2>
  </div>
  <div class="cfclear">&nbsp;</div>
</div>
...
<div class="form_item">
	<div class="form_element cf_textarea"> 
		<textarea class="cf_inputbox" rows="5" <?php echo $readOnly;?> 
			id="sinav_kosul" title="" cols="50" name="sinav_kosul"><?php echo $taslakYeterlilik["YETERLILIK_DIGER"];?></textarea>
	</div>
	<div class="cfclear">&nbsp;</div>
</div>
...
<div class="form_item">
  <div class="form_element cf_heading">
  	<h2 class="contentheading">B) Değerlendirici Ölçütleri</h2>
  </div>
  <div class="cfclear">&nbsp;</div>
</div>
...
<div class="form_item">
	<div class="form_element cf_textarea"> 
		<textarea class="cf_inputbox" rows="5" <?php echo $readOnly;?> 
			id="olcut" title="" cols="50" name="olcut"><?php echo $taslakYeterlilik["YETERLILIK_DEGERLENDIRICI"];?></textarea>
	</div>
	<div class="cfclear">&nbsp;</div>
</div>
...
?>
	<div class="form_item" style="padding-top: 25px;">
		<div class="form_element cf_button">
			<input value="Yorum Kaydet" name="kaydet" type="button"  onclick="yorumKaydet('sinav_bilgi', <?php echo $this->yeterlilik_id;?>)"/>
		</div>
		<div class="cfclear">&nbsp;</div>
	</div>
<?php 
