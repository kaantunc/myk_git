...
<div class="form_item">
  <div class="form_element cf_textbox">
    ...
    <input class="cf_inputbox required" maxlength="150" size="30"  id="text_1" name="ad" type="text" value="<?php echo FormFactory::toUpperCase($this->kurulus["KURULUS_ADI"]);?>" disabled = "disabled"/>
