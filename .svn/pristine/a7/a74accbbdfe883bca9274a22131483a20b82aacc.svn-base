...
echo 'action=index.php?option=com_yeterlilik_taslak&layout=ek_katki&'.$task.'&yeterlilik_id='.$this->yeterlilik_id;	
?> 
...
?>
	<div class="form_item" style="padding-top: 25px;">
		<div class="form_element cf_button">
			<input value="Yorum Kaydet" name="kaydet" type="button"  onclick="yorumKaydet('ek_katki', <?php echo $this->yeterlilik_id;?>)"/>
		</div>
		<div class="cfclear">&nbsp;</div>
	</div>
<?php 
...
dTables.kurulus =  new Array(new Array("text","","4", "", readOnly),new Array("text","","120", "", readOnly));
